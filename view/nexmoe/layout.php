...
<head>
	...
	<meta name="keywords" content="souhire">
	<meta name="author" content="souhire">
...
<body class="mdui-theme-primary-blue-grey mdui-theme-accent-blue">
	<header class="nav">
		<div class="navSize">
			<a href="/"><img class="avatar" src="https://i.imgur.com/tvy5Nly.jpg"/></a>
			<div class="navRight">
				<ul class="navul">
                    <li class="navli"><a style="color: black" href="/"><b><i class="mdui-icon material-icons">cloud_queue</i> Home</b></a></li>
				</ul>
				<div class="icon"></div>
			</div>
		</div>
